...
const Streamer = () => {
    ...
    // //delete
    //     // eslint-disable-next-line
    //     let testStreamer = (streamerCase) => {
    //         console.log('case now ', streamerCase);
    //         setTimeout(() => {
    //             setStreamer(streamerCase.description);
    //             setLoading(false);
    //             document.title = streamerCase.description.name;
                
    //             setTimeout(() => {
    //                 setVideos(streamerCase.videos)
    //                 setStreams(streamerCase.streams)
    //                 setOnAir(streamerCase.stream)
    //             }, 1000)
    //         }, 2000);
    //     };
    // //delete
