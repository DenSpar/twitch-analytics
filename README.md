...
дальше: бэк:
15) научить приложение обращаться к серверу, а не к твичу(учесть иногда работу локал хоста)
16) переписать логику приложения, чтобы вся инфа формировалась на бэке и во фронт оправлялась в готовом виде
...
+) скрипт ежедневного(чаще?) обновления кол-ва followers и views и имени
