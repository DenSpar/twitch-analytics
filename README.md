...
учесть кейс при записи статы, возможно поэтому несколько записей статы не завершились - нет
В стате лежит следующее:
maxViewers: 0
med50Viewers: null
midViewers: 0
minutes1Viewer: null
учесть этот кейс в начале записи статы и при выдаче массива со стримами