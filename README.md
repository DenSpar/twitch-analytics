...
бэк:
    ...
    48) дату начала стрима в табл стримов - преобразовать дату
    55) онлайн зрителей перенести в описание стримера: onlineViewers: {max:"1 101",middle:"438",inDays:"за 1 д."}
