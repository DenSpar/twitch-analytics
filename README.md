...
дальше:
+ добавление стримеров: должно приходить так:
{
    "newStreamer": {
...
+ удалить стримеров: должно приходить так:
...
{
    delStats: {
        message = 'статистика стримера №70075625 не найдена, нечего удалять';
        status = false;
    },
    delStreamer: {
        message = 'стример №70075625 удален из основного списка';
        status = true;
    },
    nowStream: false
    unsubWebHook: {
