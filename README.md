...
2) fix в таблице стримов в массиве указанных игр могли быть пустые строки - "". Чтобы в таблицу не добавлять пустую строку как пункт списка с играми - дописал условие на фронте

проверить:
1) fix удаления стрима из БД через апи, фикс бэка и фронта - добавить и удалить канал(можно проверить чеквебхукс)
2) fix в таблице стримов в массиве указанных игр могли быть пустые строки - "". Чтобы в таблицу не добавлять пустую строку как пункт списка с играми - дописал условие на фронте. проверить на ксанчике
