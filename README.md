...
4) при записи статы стрима в БД, добавил обработчик сравнивающий дату начала стрима и начала записию Если разница больше 5 минут появляется запись 'сбор статистики не с начала стрима'. Результат пока не видел
6) добавил скрипт записи названия игр, если они менялись
