...
36) скрипт проверки добавить перед записью стрима


приоритет 0:
сбор статы со стримов:
26) при рестарте сервера, должна быть очистка коллекции с живыми стримами + заполнение свежими + возможно, старт записи тех что идут
