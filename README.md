...
приоритет 1:
стата:
18) скрипт автоматической подписки на вебхуки + скрипт проверки подписок:
-> скрипт подписки - сделать subscribe2WebHook.js
-> проверить на апи запросах
-> переписать скрипт получения подписок на фронте, чтобы было видно сколько времени осталось
-> передать 2 массива айдишников в скрипт подписки
-> проверять на полном массиве айдишников в фронте

скрипт автоматической подписки на вебхуки + скрипт проверки подписок
