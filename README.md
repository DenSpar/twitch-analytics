...
17.11.20
1) добавил удаление из живых стримов после записи статы, пока не проверял
2) добавил скрипт добавления макс и ср онлайн за месяц в стату стримера, пока не проверял
3) добавил скрипт, формирующий объект стримера для дашборда, чтобы получать maxOnline и midOnline, пока не проверял 


обновить:
39) добавил удаление из живых стримов после записи статы
41) должен забирать из статы макс и ср онлайн за месяц
3) скрипт, формирующий объект стримера для дашборда, чтобы получать maxOnline и midOnline
