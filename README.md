...
17.11.20
1) добавил удаление из живых стримов после записи статы


проверить:
39) добавил удаление из живых стримов после записи статы

приоритет 1:
скрипт обновления статы:
41) должен забирать из статы макс и ср онлайн за месяц
для дашборда:
