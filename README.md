...
+ добавление стримеров: подкорректировать возвращаемый ответ, чтобы сформировать алерт. Пока приходит так:
{
    "refactObj": {
...
+ удалить стримеров: подкорректировать возвращаемый ответ, чтобы сформировать алерт. Пока приходит та
"Asmadey" - 83597658 - шел стрим :
{
    delStats: "статистика стримера №83597658 не найдена, нечего удалять"
    delStreamer: "стример №83597658 удален из основного списка"
    nowStream: {stream: {…}}
    unsubWebHook: "запись успешно создана"
}
"SilverName" 70075625:
{
    delStats: "статистика стримера №70075625 не найдена, нечего удалять"
    delStreamer: "стример №70075625 удален из основного списка"
    nowStream: null
    unsubWebHook: "запись успешно создана"
}
"Shelly" - 82022819 : {
    delStats: "статистика стримера №82022819 не найдена, нечего удалять"
    delStreamer: "стример №82022819 удален из основного списка"
    nowStream: null
    unsubWebHook: "запись успешно создана"
}
...
+ закомментировать удаление каналов
