...
1) переписал ответ от функции добавления новых каналов + если у канала идет стрим, перед тем как записывать статистику сначала функция проверить нет ли этого стрима в БД
2) добавил в ответ нового стримера
3) добавил функционал для отправки пароля при удаление стрима или полного удаления стримера

дальше:
+ добавление стримеров: подкорректировать возвращаемый ответ, чтобы сформировать алерт. Пока приходит так:
{
    "newStreamer": {
        followers: {actual: "15 337", diff: "-3", inDays: "за 7 д."}
        id: "46947742"
        isClosed: false
        logo: "https://static-cdn.jtvnw.net/jtv_user_pictures/46993a9e-557f-4b6b-9703-70ce9338110c-profile_image-300x300.jpg"
        name: "RIKKIDI"
        onlineViewers: {max: "-", middle: "-", inDays: null}
        stream: null
        streamsIn7Days: "-"
    },
    "addChannel": {
        "message":"Канал SilverName(70075625) добавлен в основной стэк",
        status: true
    },
    "subsWebHook":{
