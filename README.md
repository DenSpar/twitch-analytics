...
+ перенести просмотры во вкладку "архивные видео"
+ на странице стримера изменения выделять красным и зеленым -> выделить greenOrRedDiff в отдельный файл
+ ссылка на канал + добавить в бэк
+ если нет записанных стримов - выводить в табл стримов "нет стримов", как в табл видосов
+ кнопка "<- все стримеры" для возврата в дашборд - куда поставить? можно в поле где должен быть алерт
+ добавить шрифт в билд
